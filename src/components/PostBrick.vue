<template>
    <div class="brick-container">
        <div class="data">
            ...
            <!-- SPOILER -->
            <div v-else-if="brick.type == 'spoiler'" class="spoiler">
                <div @click="isHidden = !isHidden" class="spoiler-toggle">-- спойлер! --</div>
                <PostSpoilerBrick v-if="!isHidden" v-for="_brick in brick.data.bricks" :brick="_brick"></PostSpoilerBrick>
            </div>
            <!-- NONE -->
...
<script>
import PostSpoilerBrick from "./PostSpoilerBrick.vue";
...
export default {
    ...
    components: { YTFrame, PostSpoilerBrick },
};
